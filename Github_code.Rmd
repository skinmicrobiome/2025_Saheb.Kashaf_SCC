...
ggsave(filename = "final_figures/suppfig1.png",
plot = plot_age_scc,
width = 8,
height = 4)
```
...
merged_metagenomes <- import_biom(paste0("outputs/",var.name,".biom",sep=""))
...
saveRDS(physeq_orig, file=paste0(var.name, ".rds"))
...
ggsave("final_figures/fig1.png",fig1, width=13, height=15)
```
...
ggsave("final_figures/suppfig2.png",suppfig2, width=12, height=12)
...
heatmapData = readRDS("met_hpv_git.RDS")
...
ggsave("final_figures/fig2.png",fig2,width=17,height=16)
...
ggsave("final_figures/suppfig3.png",width = 13, height=10)
